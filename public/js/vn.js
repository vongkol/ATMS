	...
	for(var i=0;i<numvalue.length;i++)
	{
		...
		if(numb.toString().length === 2)
		{
			var obj2 = {
				...
				m: getNum(numvalue[i].split('_')[1]) + getFirst(numvalue[i].split('_')[1]) + getLast(numvalue[i].split('_')[1]) + getShuff(numvalue[i].split('_')[1])
			};		
			console.log(obj2);
			...
			element2 += '<tr data-original="' + obj2.original + '" data-subtotal="' + obj2.luy * k * obj2.m + '"><td class="text-center"><i class="fa fa-trash-o" onclick="deleterow2(this)" data-k="' + k + '" data-luy="' + obj2.luy + '"></i></td><td>' + obj2.index + '</td><td>' + obj2.num + '</td><td>' + obj2.luy + '</td>' + 
		...
		{			
			...
			element3 += '<tr data-original="' + obj3.original + '" data-subtotal="' + obj3.luy * k * obj3.m + '"><td class="text-center"><i class="fa fa-trash-o" onclick="deleterow3(this)" data-k="' + k + '" data-luy="' + obj3.luy + '"></i></td><td>' + obj3.index + '</td><td>' + obj3.num + '</td><td>' + obj3.luy + '</td>' +
