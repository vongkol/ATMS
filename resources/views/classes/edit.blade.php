        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> {{$lb_edit_class}}&nbsp;&nbsp;
                ...
                <div class="card-block">
                    ...
                    <form action="{{url('/class/update')}}" onsubmit="return confirm('{{$lb_confirm_update}}')"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="text" required autofocus name="name" id="name" class="form-control" value="{{$class->name}}">
                            </div>
                        </div>
                        <div class="form-group row">
