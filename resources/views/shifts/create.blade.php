        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> បង្កើតវេនធ្វើការថ្មី&nbsp;&nbsp;
                ...
                <div class="card-block">
                    ...
                    <form action="{{url('/shift/save')}}" class="form-horizontal" method="post">
                        {{csrf_field()}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-5 col-sm-8">
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="time" class="form-control" name="capture_in_start" id="capture_in_start">
                                        </td>
                                        <td>
                                            <input type="time" class="form-control" name="time_in" id="time_in">
                                        </td>
                                        <td>
                                            <input type="time" class="form-control" name="capture_in_end" id="capture_in_end">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-lg-5 col-sm-8">
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="time" class="form-control" name="capture_out_start" id="capture_out_start">
                                        </td>
                                        <td>
                                            <input type="time" class="form-control" name="time_out" id="time_out">
                                        </td>
                                        <td>
                                            <input type="time" class="form-control" name="capture_out_end" id="capture_out_end">
                                        </td>
                                    </tr>
                                </table>
                            </div>
