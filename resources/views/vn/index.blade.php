            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form action="#" class="form-horizontal checkbox-head">
                        ...
                        <label><input type="checkbox" name="type" id="a4" onchange="forA()"> &nbsp;A-4 P </label>
                        <label><input type="checkbox" name="type" id="p6" onchange="forP6()"> &nbsp;6 P {{$lb_night}}</label>
                        <label><input type="checkbox" name="type" id="p7" onchange="forP7()"> &nbsp;7 P {{$lb_night}}</label>
                        <label>|</label>
                        <label><input type="radio" name="shift" checked value="day" id="day" onchange="forDay()"> {{$lb_day}}</label>
                        <label><input type="radio" name="shift" value="night" id="night" onchange="forDay()"> {{$lb_night}}</label>
                        ...
                        <p>
                            ...
                            <a href="#" class="btn btn-xs btn-xx btn-danger">{{$lb_clear}}</a>
                        </p>
                    </form>
