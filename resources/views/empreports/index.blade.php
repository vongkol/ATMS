		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header text-bold">
                    <i class="fa fa-user"></i> តារាងបុគ្គលិក    &nbsp;&nbsp;
                    ...
                    <table class="table table-condensed table-striped table-responsive">
                        ...
                        @foreach($employees as $emp)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('/empreport/profile/'.$emp->id)}}" title="បោះពុម្ភ" class="btnprint"><i class="fa fa-print text-success"></i></a> 
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                ...
                <div style="padding-left: 20px;">
                    <a href="{{url('/empreport/list')}}" title="បោះពុម្ភ" class="btnprint"><i class="fa fa-print text-success"></i>បោះពុម្ភទាំងអស់</a>
                </div>
			</div>
		</div>
	</div>
        ...
        $('#btnSearch').on('click', function(){
            ...
            success: function (data) {
                ...
                for(var i=0; i<employees.length; i++)
                {
                    ...
                    tr += "<td>" + employees[i].department_name + "</td>";
                    tr += "<td>" +
