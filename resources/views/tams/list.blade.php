<html>
    ...
    <body>
        <table style="width: 80%; margin: 0 auto; border: 0px solid; border-collapse: collapse;">
            ...
            <tr>
                <td colspan="6" style="padding-top: 30px; padding-bottom: 30px;" class="head2">បញ្ជីវត្តមានមន្រ្តី</td>
            </tr>
            <tr>
                <td>
                    <table width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$tam->khm_name}}</td>
                                <td style="text-align: center;">{{$tam->date_in}}</td>
                                <td style="text-align: center;">{{$tam->date_out}}</td>
                                <td style="text-align: center;">{{$tam->time_in}}</td>
                                <td style="text-align: center;">{{$tam->time_out}}</td>
                                <td style="text-align: center;">{{$tam->work_hour}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
