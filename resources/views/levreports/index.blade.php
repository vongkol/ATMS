		...
		<div class="col-lg-12">
			<div class="card">
                    ...
                    <table class="table table-condensed table-striped table-responsive">
                        ...
                        @foreach($leaves as $lea)
                            <tr>
                                ...
                                <td>{{$lea->department_name}}</td>
                                <td>
                                    <a href="{{url('/levreport/indreport/'.$lea->id)}}" class="btnprint" title="បោះពុម្ភ"><i class="fa fa-print text-success"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                ...
                <div style="padding-left: 20px;">
                    <a href="{{url('/levreport/list')}}" title="បោះពុម្ភ" class="btnprint"><i class="fa fa-print text-success"></i>បោះពុម្ភទាំងអស់</a>
                </div>
			</div>
		</div>
	</div>
