        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> កែប្រឈ្មោះតួនាទី&nbsp;&nbsp;
                ...
                <div class="card-block">
                    ...
                    <form action="{{url('/position/update')}}" class="form-horizontal" method="post">
                        {{csrf_field()}}
                        <input type="hidden" name="id" value="{{$position->id}}">
                        <div class="form-group row">
                            <label for="name" class="control-label col-lg-1 col-sm-2">{{$lb_name}}</label>
                            <div class="col-lg-6 col-sm-8">
                                <input type="text" required name="name" id="name" class="form-control" autofocus value="{{$position->name}}">
                            </div>
                        </div>                     
                        <div class="form-group row">
