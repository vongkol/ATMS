        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> បង្កើតប្រភេទច្បាប់ថ្មី&nbsp;&nbsp;
                    <a href="{{url('/leavetype')}}" class="btn btn-link btn-sm">{{$lb_back_to_list}}</a>
                </div>
                <div class="card-block">
                    ...
                    <form action="{{url('/leavetype/save')}}" class="form-horizontal" method="post">
                        {{csrf_field()}}
