            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form action="#" class="form-horizontal checkbox-head">
                        ...
                        <label>|</label>
                        <label><input type="radio" name="shift" checked value="day" id="day"> {{$lb_day}}</label>
                        <label><input type="radio" name="shift" value="night" id="night"> {{$lb_night}}</label>
...
@section('js')
 <!-- Modal -->
    ...
    <script src="{{asset('js/thai.js')}}"></script>
@endsection